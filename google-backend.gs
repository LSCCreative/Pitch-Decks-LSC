...
// ===== Configuration =========================================================
var CONFIG = {
  PITCHES_FOLDER_ID: "1HPsoa3Kg3uII7QzhybnYBSx1kLxOmTbq", // Drive folder holding *.json pitches
  CONFIG_SHEET_ID: "1wIGdx1jjmynyCmozFZ3W7Ludn00FvWxsTSypsbyk2zQ",          // Spreadsheet holding dropdown values
